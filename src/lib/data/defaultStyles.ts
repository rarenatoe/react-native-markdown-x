...
import type { FlattenedStyleMap } from "../../types";

// this is converted to a stylesheet internally at run time with StyleSheet.create(
export const DEFAULT_STYLES: FlattenedStyleMap = {
  // The main container
  body: {},
  ...
  list_item_bullet_marker: {
    marginLeft: 10,
    marginRight: 10,
  },
  // @pseudo class, does not have a unique render rule
  list_item_bullet_content: {
    flex: 1,
  },
  // @pseudo class, does not have a unique render rule
  list_item_ordered_marker: {
    marginLeft: 10,
    marginRight: 10,
  },
  // @pseudo class, does not have a unique render rule
  list_item_ordered_content: {
    flex: 1,
  },
